...
const categories = [
  ...
  { id: 'Entrepreneurship & Business Skills', name: '🚀 Entrepreneurship', color: 'bg-green-600' },
  ...
  { id: 'Financial & Investment Literacy', name: '💰 Finance', color: 'bg-emerald-600' },
  { id: 'Career Development & Employability Skills', name: '📈 Career', color: 'bg-red-600' },
  { id: 'Digital Economy & Future Skills', name: '🔮 Future Skills', color: 'bg-indigo-600' },
]
