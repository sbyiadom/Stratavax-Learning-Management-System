...
export default async function LessonPage({
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href={`/dashboard/learn/${params.courseId}`} className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition shadow-lg">
            <ChevronLeft size={18} />
            Back to Course
          </Link>
        </div>
  ...
  const markComplete = async () => {
    ...
    // Redirect to refresh
    redirect(`/dashboard/learn/${params.courseId}/${params.lessonId}`)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 mt-8 pt-6 border-t border-gray-200">
          {prevLesson ? (
            <Link
              href={`/dashboard/learn/${params.courseId}/${prevLesson.id}`}
          ...
          {nextLesson ? (
            <Link
              href={`/dashboard/learn/${params.courseId}/${nextLesson.id}`}
