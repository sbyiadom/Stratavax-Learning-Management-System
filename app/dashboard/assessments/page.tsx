...
import { CheckSquare, Award, Calendar, ChevronRight, FileText, TrendingUp } from 'lucide-react'
                  ...
                  <div className="p-5">
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className={`font-medium ${assessment.post_assessment_score && assessment.post_assessment_score >= assessment.pass_mark ? 'text-green-600' : assessment.post_assessment_score ? 'text-red-600' : 'text-gray-500'}`}>
                      ...
                      {improvement !== null && (
                        <div className="flex justify-between text-sm">
                          ...
                          <div className="flex items-center gap-1">
                            <TrendingUp className={`w-3 h-3 ${improvement > 0 ? 'text-green-600' : 'text-red-600'}`} />
