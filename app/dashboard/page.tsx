...
import { 
  ...
  BarChart3, Calendar, Target, Sparkles
} from 'lucide-react'
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <div className="flex-1">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          {/* Hero Section */}
          <div className="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 p-8 shadow-xl">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-gray-300 text-sm font-medium uppercase tracking-wider">{greeting}</span>
              </div>
          ...
          {/* Quick Actions - Now with better visibility */}
          <div className="mb-10">
              ...
              >
                <div className="p-6">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition">
                      <FileSpreadsheet className="text-white" size={26} />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-800 mb-1">Training Registration</h3>
                      <p className="text-sm text-gray-500">Submit training attendance and evaluation</p>
                    </div>
                    <ExternalLink className="text-gray-400 group-hover:text-green-600 transition" size={20} />
                  </div>
                </div>
              </a>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-800 mb-1">Request a Course</h3>
          ...
          {/* Learning Analytics - Enhanced cards */}
          <div className="mb-10">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-xl font-semibold text-gray-800">Learning Analytics</h2>
              <Link href="/dashboard/progress" className="text-blue-600 text-sm hover:text-blue-700 flex items-center gap-1 font-medium">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
              <div className="bg-white rounded-xl p-5 shadow-md hover:shadow-lg transition border border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-3xl font-bold text-gray-800">{validEnrollments.length}</span>
                </div>
                <p className="text-gray-600 font-medium">Enrolled Courses</p>
                <p className="text-xs text-gray-400 mt-1">Active learning</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-5 shadow-md hover:shadow-lg transition border border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-3xl font-bold text-gray-800">{progressPercentage}%</span>
                </div>
              ...
              <div className="bg-white rounded-xl p-5 shadow-md hover:shadow-lg transition border border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-3xl font-bold text-gray-800">{certificates?.length || 0}</span>
                </div>
                <p className="text-gray-600 font-medium">Certificates</p>
                <p className="text-xs text-gray-400 mt-1">Earned credentials</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-5 shadow-md hover:shadow-lg transition border border-gray-100">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-3xl font-bold text-gray-800">{completedLessons}</span>
                </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/dashboard/courses" className="text-blue-600 text-sm hover:text-blue-700 flex items-center gap-1 font-medium">
            ...
            {validEnrollments.length > 0 ? (
                      ...
                      <div className="h-36 bg-gradient-to-r from-gray-800 to-gray-900 relative">
                        ...
                        <div className="absolute bottom-4 left-5 right-5">
                          <div className="flex items-center justify-between text-white">
                            <span className="text-xs font-medium bg-white/20 px-2.5 py-1 rounded-lg backdrop-blur-sm">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-1 bg-white/20">
                          <div className="h-full bg-gradient-to-r from-blue-400 to-blue-500 transition-all" style={{ width: `${progress}%` }}></div>
                        </div>
                      </div>
                      <div className="p-5">
              ...
              <div className="bg-white rounded-xl p-12 text-center shadow-md border border-gray-100">
                ...
                <p className="text-gray-500 mb-6">Begin your professional development journey</p>
                <Link href="/dashboard/courses" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition shadow-md">
            ...
            <div className="mt-10 pt-6 border-t border-gray-200">
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200 shadow-sm">
                <div className="flex items-center justify-between flex-wrap gap-4">
                  ...
                  <Link href="/admin/reports" className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition shadow-md text-sm font-medium">
                    Access Reports <ChevronRight size={16} />
                  </Link>
                </div>
              </div>
            </div>
